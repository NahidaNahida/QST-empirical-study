"""
Code for the data analysis of RQ7 Evaluation Metrics
"""
...
def whether_reporting_metrics(
    ...
    config_data: dict, 
    config_figure: dict,  
    saving_name: str = "rq7_metrics_venn.pdf",
) -> None:
...
def metrics_table(
    df: pd.DataFrame,
    config_data: dict,
    saving_name: str = "rq7_metrics_names.tex",     
) -> None:
    ...
    multi_data, saving_path = data_preprocess(
        df, 
        ["rq7_effectiveness", "rq7_cost", "primary_study_id", "SE_problem"], 
        config_data, 
        ROOT_DIR, 
        TAB_SAVING_DIR,
        saving_name
