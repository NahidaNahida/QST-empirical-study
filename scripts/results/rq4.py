"""
Code for the data analysis of RQ4 Contrastive Analysis
"""

from src import (
    read_csv, read_config_json,
    line_chart, pie_chart, horizontal_bar_chart, vertical_bar_chart, data_clean,
    vertical_tables,
...
def baseline_numbers(
    ...
    config_data: dict, 
    config_figure: dict,  
    saving_name: str = "rq4_number_of_baselines.pdf",
) -> None:
...
def baseline_motivations(
    ...
    config_data: dict, 
    config_figure: dict,  
    saving_name: str = "rq4_inclusion_motivation.pdf",
) -> None:
...
def baseline_names(
    df: pd.DataFrame,
    config_data: dict, 
    saving_name: str = "rq4_baseline_names.tex",
):
    """
    ...
    multi_data, saving_path = data_preprocess(
        df, 
        [
            "rq4_baseline_names", "rq4_baseline_motivation",
...
def statistical_tests_for_comparison(
    df: pd.DataFrame,
    config_data: dict, 
    saving_name: str = "rq4_baseline_comparison.tex",
):
    """
