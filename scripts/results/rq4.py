"""
Code for the data analysis of RQ4 Test Inputs
"""
...
def whether_reporting_test_counts(
    ...
    config_data: dict, 
    config_figure: dict,  
    saving_name: str = "rq4_whether_counts.pdf",
) -> None:
...
def input_type_distribution(    
    ...
    config_data: dict, 
    config_figure: dict,  
    saving_name: str = "rq4_input_type_distribution.pdf",
) -> None:
    # Instant configuration
    TEMP_CONFIG_UPSET = {
        "figsize": (5, 2.5),
...
def input_type_name(    
    df: pd.DataFrame,
    config_data: dict, 
    saving_name: str = "rq4_input_type_names.tex",
) -> None:
    # Instant configuration
    TEMP_CONFIG = {
    ...
    multi_data, saving_path = data_preprocess(
        df, 
        ["rq4_input_types", "primary_study_id"],         
        config_data, 
        ROOT_DIR, 
        TAB_SAVING_DIR,
        saving_name
